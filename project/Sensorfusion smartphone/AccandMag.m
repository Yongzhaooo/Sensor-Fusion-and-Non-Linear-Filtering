...
Rw = diag([0.001220,0.000731,0.000493]); % gyro covariance
g0 = [0.219950 -0.028492 9.863996]';
Ra = diag([0.011359, 0.012691, 0.022681]); % acc covariance
myport =3401;
...
try
    %% Create data link
    server = StreamSensorDataReader(myport);
